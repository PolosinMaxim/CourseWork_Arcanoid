...
#pygame.mixer.init()  # для звука
    ...
    def check_bricks(self):
        ...
        for brick in self.bricks:
            ...
            if self.ball.y_speed > 0 and coll_vert and self.ball.ball_y + self.ball.ball_radius > brick.y and self.ball.ball_y + self.ball.ball_radius < brick.y + brick_height:
                self.ball.y_speed *= -1 #top
            elif self.ball.y_speed < 0 and coll_vert and self.ball.ball_y - self.ball.ball_radius > brick.y and self.ball.ball_y - self.ball.ball_radius < brick.y + brick_height:
                self.ball.y_speed *= -1 #bottom
            elif self.ball.x_speed > 0 and coll_horz and self.ball.ball_x + self.ball.ball_radius > brick.x and self.ball.ball_x + self.ball.ball_radius < brick.x + brick_width:
